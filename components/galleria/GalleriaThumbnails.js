...
function (_Component) {
  ...
  function GalleriaThumbnailItem(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(GalleriaThumbnailItem).call(this, props));
...
function (_Component2) {
  ...
  function GalleriaThumbnails(props) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(GalleriaThumbnails).call(this, props));
    _this2.state = {
  ...
  _createClass(GalleriaThumbnails, [{
    ...
    value: function renderItems() {
      ...
      var items = this.props.value.map(function (item, index) {
        ...
        return _react.default.createElement(GalleriaThumbnailItem, {
          key: index,
          index: index,
