...
var ColorPicker = exports.ColorPicker = function (_Component) {
    ...
    _createClass(ColorPicker, [{
        ...
        value: function onHueMousedown(event) {
            ...
            this.pickHue(event);
            _DomHandler2.default.addClass(this.container, 'p-colorpicker-dragging');
        }
    }, {
        key: 'pickHue',
        ...
        value: function show() {
            ...
            setTimeout(function () {
                _DomHandler2.default.addClass(_this2.panel.element, 'p-input-overlay-visible');
                _DomHandler2.default.removeClass(_this2.panel.element, 'p-input-overlay-hidden');
            }, 1);
        ...
        value: function onDocumentMouseUp() {
            ...
            _DomHandler2.default.removeClass(this.container, 'p-colorpicker-dragging');
        ...
        value: function renderColorSelector() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(el) {
                    ...
                    }, className: 'p-colorpicker-color-selector', onMouseDown: this.onColorMousedown.bind(this) },
        ...
        value: function renderHue() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(el) {
                    ...
                    }, className: 'p-colorpicker-hue', onMouseDown: this.onHueMousedown.bind(this) },
                _react2.default.createElement('div', { ref: function ref(el) {
        ...
        value: function renderInput() {
            ...
            if (!this.props.inline) {
                var inputClassName = (0, _classnames2.default)('p-colorpicker-preview p-inputtext', {
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-colorpicker p-component', this.props.className, { 'p-colorpicker-overlay': !this.props.inline });
