    ...
    _createClass(TreeTableRow, [{
        ...
        value: function renderToggler() {
            ...
            return _react2.default.createElement(
                'a',
                { className: 'p-treetable-toggler p-unselectable-text', tabIndex: '0', onClick: this.onTogglerClick, style: style },
        ...
        value: function renderChildren() {
            ...
            if (this.isExpanded() && this.props.node.children) {
                return this.props.node.children.map(function (childNode) {
                    return _react2.default.createElement(TreeTableRow, { key: childNode.key || JSON.stringify(childNode.data), level: _this5.props.level + 1,
                        node: childNode, columns: _this5.props.columns, expandedKeys: _this5.props.expandedKeys,
                        onToggle: _this5.props.onToggle, onExpand: _this5.props.onExpand, onCollapse: _this5.props.onCollapse,
                        selectionMode: _this5.props.selectionMode, selectionKeys: _this5.props.selectionKeys, onSelectionChange: _this5.props.onSelectionChange,
                        metaKeySelection: _this5.props.metaKeySelection, onRowClick: _this5.props.onRowClick, onSelect: _this5.props.onSelect, onUnselect: _this5.props.onUnselect,
                        propagateSelectionUp: _this5.props.propagateSelectionDown, propagateSelectionDown: _this5.props.propagateSelectionDown, onPropagateUp: _this5.propagateUp });
                });
            } else {
                return null;
            }
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)({ 'p-highlight': this.isSelected() });
            var cells = this.props.columns.map(function (col) {
                return _this6.renderCell(col);
            });
