...
function (_Component) {
  ...
  function Galleria(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Galleria).call(this, props));
    _this.state = {
      visible: false,
  ...
  _createClass(Galleria, [{
    ...
    value: function renderElement() {
      ...
      var closeIcon = this.props.fullScreen && _react.default.createElement("button", {
        type: "button",
      ...
      }, closeIcon, header, _react.default.createElement("div", {
        className: "p-galleria-content"
      }, _react.default.createElement(_GalleriaPreview.GalleriaPreview, {
        ref: function ref(el) {
      ...
      }), this.props.showThumbnails && _react.default.createElement(_GalleriaThumbnails.GalleriaThumbnails, {
        containerId: this.id,
        value: this.props.value,
        activeItemIndex: this.activeItemIndex,
        onActiveItemChange: this.onActiveItemChange,
    ...
    value: function renderGalleria() {
      ...
      if (this.props.fullScreen) {
        ...
        var galleriaWrapper = _react.default.createElement("div", {
          ref: function ref(el) {
