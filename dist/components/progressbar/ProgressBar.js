...
var ProgressBar = exports.ProgressBar = function (_Component) {
    ...
    _createClass(ProgressBar, [{
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-progressbar p-component', this.props.className, { 'p-progressbar-determinate': this.props.mode === 'determinate', 'p-progressbar-indeterminate': this.props.mode === 'indeterminate' });
            if (this.props.showValue) {
                ...
                var label = _react2.default.createElement(
                    'div',
                    { className: 'p-progressbar-label', style: { display: this.props.value ? 'block' : 'none' } },
                    labelText
                );
            }
            ...
            if (this.props.mode === 'indeterminate') {
                var container = _react2.default.createElement(
                    ...
                    _react2.default.createElement('div', { className: 'p-progressbar-value p-progressbar-value-animate', style: { width: this.props.value + '%', display: 'block' } })
                );
                ...
                var valueText = _react2.default.createElement('div', { className: 'p-progressbar-value p-progressbar-value-animate', style: { width: this.props.value + '%', display: 'block' } });
