    ...
    _createClass(Sidebar, [{
        ...
        value: function enableModality() {
            if (!this.mask) {
                ...
                _DomHandler2.default.addMultipleClasses(this.mask, 'p-component-overlay p-sidebar-mask');
        ...
        value: function renderCloseIcon() {
            if (this.props.showCloseIcon) {
                return _react2.default.createElement(
                    'a',
                    { className: 'p-sidebar-close', role: 'button', onClick: this.onCloseClick },
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-sidebar p-component', this.props.className, 'p-sidebar-' + this.props.position, { 'p-sidebar-active': this.props.visible, 'p-sidebar-full': this.props.fullScreen });
