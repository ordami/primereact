...
var PickList = exports.PickList = function (_Component) {
    ...
    _createClass(PickList, [{
        ...
        value: function scrollInView(listElement, direction) {
            var listContainer = _DomHandler2.default.findSingle(listElement, '.p-picklist-list');
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-picklist p-component', this.props.className, {
