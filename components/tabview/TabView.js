...
var TabView = exports.TabView = function (_Component2) {
    ...
    _createClass(TabView, [{
        ...
        value: function renderTabHeader(tab, index) {
            ...
            var className = (0, _classnames2.default)(tab.props.headerClassName, { 'p-tabview-selected p-highlight': selected, 'p-disabled': tab.props.disabled });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    tab.props.leftIcon && _react2.default.createElement('span', { className: (0, _classnames2.default)('p-tabview-left-icon ', tab.props.leftIcon) }),
                    _react2.default.createElement(
                        'span',
                        { className: 'p-tabview-title' },
                        tab.props.header
                    ),
                    tab.props.rightIcon && _react2.default.createElement('span', { className: (0, _classnames2.default)('p-tabview-right-icon ', tab.props.rightIcon) })
                )
            );
        }
    }, {
        ...
        value: function renderNavigator() {
            ...
            return _react2.default.createElement(
                'ul',
                { className: 'p-tabview-nav p-reset', role: 'tablist' },
                headers
            );
        }
    }, {
        ...
        value: function renderContent() {
            ...
            var contents = _react2.default.Children.map(this.props.children, function (tab, index) {
                ...
                var className = (0, _classnames2.default)(tab.props.contentClassName, 'p-tabview-panel', { 'p-hidden': !selected });
        ...
        value: function render() {
            var className = (0, _classnames2.default)('p-tabview p-component p-tabview-top', this.props.className);
