    ...
    _createClass(Accordion, [{
        ...
        value: function componentDidUpdate() {
            ...
            if (this.togglingTabIndex != null && this.togglingTabIndex >= 0) {
                ...
                _DomHandler2.default.addClass(expandingTabContent, 'p-accordion-content-wrapper-expanding');
                setTimeout(function () {
                    _DomHandler2.default.removeClass(expandingTabContent, 'p-accordion-content-wrapper-expanding');
        ...
        value: function renderTabHeader(tab, selected, index) {
            ...
            var tabHeaderClass = (0, _classnames2.default)(tab.props.headerClassName, 'p-accordion-header', { 'p-highlight': selected, 'p-disabled': tab.props.disabled });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('span', { className: (0, _classnames2.default)('p-accordion-toggle-icon pi pi-fw', { 'pi-caret-right': !selected, 'pi-caret-down': selected }) }),
                    _react2.default.createElement(
                        'span',
        ...
        value: function renderTabContent(tab, selected, index) {
            var tabContentWrapperClass = (0, _classnames2.default)(tab.props.contentClassName, 'p-accordion-content-wrapper', {
        ...
        value: function renderTab(tab, index) {
            ...
            return _react2.default.createElement(
                'div',
                { key: tab.props.header, className: 'p-accordion-tab' },
                tabHeader,
                tabContent
            );
        }
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-accordion p-component p-reset', this.props.className);
