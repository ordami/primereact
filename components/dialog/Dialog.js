...
var Dialog = exports.Dialog = function (_Component) {
    ...
    function Dialog(props) {
        ...
        _this.onCloseKeyPress = _this.onCloseKeyPress.bind(_this);
        _this.onMaximizeKeyPress = _this.onMaximizeKeyPress.bind(_this);
    ...
    _createClass(Dialog, [{
        ...
        value: function hide() {
            ...
            if (this.state.maximized) {
                _DomHandler2.default.removeClass(document.body, 'p-overflow-hidden');
            }
        }
    }, {
        key: 'focus',
        value: function focus() {
            var focusable = _DomHandler2.default.findSingle(this.container, 'button');
            if (focusable) {
                focusable.focus();
            }
        }
        ...
        value: function maximize() {
            _DomHandler2.default.addClass(this.container, 'p-dialog-maximized');
            ...
            _DomHandler2.default.addClass(document.body, 'p-overflow-hidden');
        }
    }, {
        key: 'restoreMaximize',
        value: function restoreMaximize() {
            ...
            setTimeout(function () {
                return _DomHandler2.default.removeClass(_this2.container, 'p-dialog-maximized');
            }, 300);
        }
    }, {
        key: 'center',
        ...
        value: function enableModality() {
            ...
            if (!this.mask) {
                ...
                _DomHandler2.default.addMultipleClasses(this.mask, 'p-component-overlay p-dialog-mask');
        ...
        value: function initDrag(event) {
            ...
            if (this.props.draggable) {
                ...
                _DomHandler2.default.addClass(document.body, 'p-unselectable-text');
            }
        }
    }, {
        key: 'onDrag',
        ...
        value: function endDrag(event) {
            if (this.props.draggable) {
                this.dragging = false;
                _DomHandler2.default.removeClass(document.body, 'p-unselectable-text');
            }
        }
    }, {
        key: 'initResize',
        ...
        value: function onResize(event) {
            if (this.resizing) {
                ...
                var contentHeight = _DomHandler2.default.getOuterHeight(this.contentElement);
        ...
        key: 'onCloseKeyPress',
        value: function onCloseKeyPress(event) {
            if (event.key === 'Enter') {
                this.onClose(event);
            }
        }
    }, {
        key: 'onMaximizeKeyPress',
        value: function onMaximizeKeyPress(event) {
            if (event.key === 'Enter') {
        ...
        value: function renderCloseIcon() {
            if (this.props.closable) {
                return _react2.default.createElement(
                    'a',
                    { tabIndex: '0', role: 'button', className: 'p-dialog-titlebar-icon p-dialog-titlebar-close', onClick: this.onClose, onMouseDown: this.onCloseMouseDown, onKeyPress: this.onCloseKeyPress },
        ...
        value: function renderMaximizeIcon() {
            ...
            if (this.props.maximizable) {
                return _react2.default.createElement(
                    'a',
                    { tabIndex: '0', role: 'button', className: 'p-dialog-titlebar-icon p-dialog-titlebar-maximize', onClick: this.toggleMaximize, onKeyPress: this.onMaximizeKeyPress },
            ...
            if (this.props.showHeader) {
                ...
                return _react2.default.createElement(
                    ...
                    { ref: function ref(el) {
                        ...
                        }, className: 'p-dialog-titlebar', onMouseDown: this.initDrag },
                    _react2.default.createElement(
                        'span',
                        { id: this.id + '_label', className: 'p-dialog-title' },
                        this.props.header
                    ),
                    _react2.default.createElement(
                        'div',
        ...
        value: function renderContent() {
            ...
            return _react2.default.createElement(
                ...
                { ref: function ref(el) {
                    ...
                    }, className: 'p-dialog-content', style: this.props.contentStyle },
                this.props.children
            );
        }
    }, {
        ...
        value: function renderResizer() {
            if (this.props.resizable) {
                return _react2.default.createElement('div', { className: 'p-resizable-handle', onMouseDown: this.initResize });
            } else {
                return null;
            }
        }
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-dialog p-component', this.props.className, {
