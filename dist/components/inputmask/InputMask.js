...
var InputMask = exports.InputMask = function (_Component) {
    ...
    _createClass(InputMask, [{
        ...
        value: function updateFilledState() {
            if (this.input && this.input.value && this.input.value.length > 0) _DomHandler2.default.addClass(this.input, 'p-filled');else _DomHandler2.default.removeClass(this.input, 'p-filled');
        }
    }, {
        key: 'updateValue',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_InputText.InputText, { id: this.props.id, ref: function ref(el) {
                    return _this6.input = _reactDom2.default.findDOMNode(el);
