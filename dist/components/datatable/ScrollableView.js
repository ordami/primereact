...
var ScrollableView = exports.ScrollableView = function (_Component) {
    ...
    _createClass(ScrollableView, [{
        ...
        value: function calculateRowHeight() {
            var row = _DomHandler2.default.findSingle(this.scrollTable, 'tr:not(.p-datatable-emptymessage-row)');
            if (row) {
        ...
        value: function render() {
            ...
            var tableClassName = (0, _classnames2.default)({ 'p-datatable-virtual-table': this.props.virtualScroll });
