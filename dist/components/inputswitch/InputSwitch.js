...
var InputSwitch = exports.InputSwitch = function (_Component) {
    ...
    _createClass(InputSwitch, [{
        ...
        value: function onFocus(event) {
            _DomHandler2.default.addClass(this.container, 'p-inputswitch-focus');
        ...
        value: function onBlur(event) {
            _DomHandler2.default.removeClass(this.container, 'p-inputswitch-focus');
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-inputswitch p-component', this.props.className, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('span', { className: 'p-inputswitch-slider' })
            );
        }
    }]);
