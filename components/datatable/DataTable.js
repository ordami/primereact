...
var DataTable = exports.DataTable = function (_Component) {
    ...
    _createClass(DataTable, [{
        ...
        value: function onSort(event) {
            ...
            var singleSortOrder = this.getSortField() === event.sortField ? this.getSortOrder() * -1 : 1;
                ...
                if (this.props.columnResizeMode === 'fit') {
                    ...
                    if (newColumnWidth > 15 && nextColumnWidth > 15) {
                        ...
                        if (this.props.scrollable) {
                            var colGroup = _DomHandler2.default.findSingle(this.container, 'colgroup.p-datatable-scrollable-colgroup');
                    ...
                    var table = _DomHandler2.default.findSingle(this.container, 'tbody.p-datatable-tbody').parentElement;
                    table.style.width = table.offsetWidth + delta + 'px';
                    this.resizeColumn.style.width = newColumnWidth + 'px';
                    var containerWidth = table.style.width;

                    if (this.props.scrollable) {
                        _DomHandler2.default.findSingle(this.container, '.p-datatable-scrollable-header-box').children[0].style.width = containerWidth;
                        var _colGroup = _DomHandler2.default.findSingle(this.container, 'colgroup.p-datatable-scrollable-colgroup');
        ...
        value: function createScrollableView(value, columns, frozen, headerColumnGroup, footerColumnGroup, totalRecords) {
            return _react2.default.createElement(_ScrollableView.ScrollableView, { columns: columns, header: this.createTableHeader(columns, headerColumnGroup),
                ...
                onVirtualScroll: this.onVirtualScroll, loading: this.props.loading });
        }
    }, {
        key: 'getColumns',
        ...
        value: function renderLoader() {
            var iconClassName = (0, _classnames2.default)('p-datatable-loading-icon pi-spin', this.props.loadingIcon);

            return _react2.default.createElement(
                'div',
                { className: 'p-datatable-loading' },
                _react2.default.createElement('div', { className: 'p-datatable-loading-overlay p-component-overlay' }),
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-datatable p-component', { 'p-datatable-responsive': this.props.responsive, 'p-datatable-resizable': this.props.resizableColumns,
            ...
            var resizeHelper = this.props.resizableColumns && _react2.default.createElement('div', { ref: function ref(el) {
                ...
                }, className: 'p-column-resizer-helper p-highlight', style: { display: 'none' } });
