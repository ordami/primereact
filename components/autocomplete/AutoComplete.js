...
var AutoComplete = exports.AutoComplete = function (_Component) {
    ...
    _createClass(AutoComplete, [{
        ...
        value: function removeItem(event, index) {
            var removedValue = this.props.selection[index];
                ...
                switch (event.which) {
                    ...
                    case 8:
                        if (this.props.selection && this.props.selection.length && !this.inputEl.value) {
                            var removedValue = this.props.selection[this.props.selection.length - 1];
                            var newValue = this.props.selection.slice(0, -1);
        ...
        value: function isSelected(val) {
            ...
            if (this.props.selection && this.props.selection.length) {
                for (var i = 0; i < this.props.selection.length; i++) {
                    if (_ObjectUtils2.default.equals(this.props.selection[i], val)) {
                        selected = true;
                        break;
                    }
                }
        ...
        value: function renderChips() {
            ...
            if (this.props.selection && this.props.selection.length) {
                return this.props.selection.map(function (val, index) {
