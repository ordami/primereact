...
var SplitButton = exports.SplitButton = function (_Component) {
    ...
    _createClass(SplitButton, [{
        ...
        value: function render() {
            ...
            var className = (0, _classnames2.default)('p-splitbutton p-buttonset p-component', this.props.className, { 'p-disabled': this.props.disabled });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_Button.Button, { type: 'button', icon: this.props.icon, label: this.props.label, onClick: this.props.onClick, disabled: this.props.disabled, tabIndex: this.props.tabIndex }),
                _react2.default.createElement(_Button.Button, { type: 'button', className: 'p-splitbutton-menubutton', icon: 'pi pi-caret-down', onClick: this.onDropdownButtonClick, disabled: this.props.disabled }),
