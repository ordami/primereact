...
var MultiSelectHeader = exports.MultiSelectHeader = function (_Component) {
    ...
    _createClass(MultiSelectHeader, [{
        ...
        value: function render() {
            ...
            var checkboxClassName = (0, _classnames2.default)('p-checkbox-box p-component', { 'p-highlight': this.props.allChecked });
            var checkboxIcon = (0, _classnames2.default)('p-checkbox-icon p-clickable', { 'pi pi-check': this.props.allChecked });
            ...
            if (this.props.filter) {
                filterElement = _react2.default.createElement(
                    ...
                    _react2.default.createElement('span', { className: 'p-multiselect-filter-icon pi pi-search' })
                );
            }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'p-checkbox p-component', onClick: this.onToggleAll },
                    _react2.default.createElement(
                        'div',
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'p-multiselect-close', onClick: this.props.onClose },
